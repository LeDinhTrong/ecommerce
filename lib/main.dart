...
Future<void> main() async {
  ...
  runApp(MultiProvider(
    providers: [
      ChangeNotifierProvider(create: (context) => di.sl<ShopAllProvider>()),
      ChangeNotifierProvider(create: (context) => di.sl<PickAddGHTKProvider>()),
      ChangeNotifierProvider(create: (context) => di.sl<CreateGHTKProvider>()),
      ChangeNotifierProvider(create: (context) => di.sl<PreviewGHTKProvider>()),
      ChangeNotifierProvider(create: (context) => di.sl<WardDistrictProvider>()),
      ChangeNotifierProvider(create: (context) => di.sl<DistrictProvider>()),
      ChangeNotifierProvider(create: (context) => di.sl<PreviewProvider>()),
      ChangeNotifierProvider(create: (context) => di.sl<CreateShippingProvider>()),
      ChangeNotifierProvider(create: (context) => di.sl<ProvinceProvider>()),
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home:
          orderId == null ? SplashScreen() : OrderDetailsScreen(orderModel: null, orderId: orderId),
      // home: Tesst(),
    );
  }
}
