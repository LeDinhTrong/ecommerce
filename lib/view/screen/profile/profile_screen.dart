  ...
  _updateUserAccount() async {
    ...
    if (Provider.of<ProfileProvider>(context, listen: false)
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text('Chưa có gì thay đổi'),
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          ...
          backgroundColor: ColorResources.RED));
    } else if (!_email.contains(RegExp(
        r'^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$'))) {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text(getTranslated('EMAIL_INVALID', context)),
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text(getTranslated('PHONE_INVALID', context)),
          backgroundColor: ColorResources.RED));
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text(getTranslated('PASSWORD_INVALID', context)),
          backgroundColor: ColorResources.RED));
