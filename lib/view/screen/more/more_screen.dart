                    ...
                    isGuestMode
                        ...
                        : profile.userInfoModel == null
                            ? ClipRRect(
                                ...
                                child: Image.asset(Images.avatar_image,
                                    width: 35, height: 35, fit: BoxFit.cover),
                              )
                            : ClipRRect(
                                borderRadius: BorderRadius.circular(15),
                                child: FadeInImage.assetNetwork(
                                  placeholder: Images.avatar_image,
                                  width: 35,
                                  height: 35,
                                  fit: BoxFit.cover,
                                  image:
      ...
      child: Column(children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border:
                Border.all(width: 1, color: ColorResources.getPrimary(context)),
            color: ColorResources.WHITE,
          ),
          child: Image.asset(image, color: ColorResources.getPrimary(context)),
        ),
        Align(
