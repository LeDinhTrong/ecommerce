                        ...
                        itemBuilder: (context, index) {
                          return Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border:
                                  Border.all(color: ColorResources.getSellerTxt(context), width: 2),
                            ),
                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              Text(
                                'Ngày tạo: ${supportTicketList[index].createdAt}',
                                style:
                              ...
                              Row(children: [
                                ...
                                TextButton(
                                  ...
                                  child: Text(
                                    getTranslated(supportTicketList[index].status, context),
