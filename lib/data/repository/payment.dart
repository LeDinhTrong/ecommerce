import 'package:flutter_sixvalley_ecommerce/data/model/response/create_order_response.dart';
import 'package:flutter_sixvalley_ecommerce/utill/endpoints.dart';
import 'package:http/http.dart' as http;
import 'dart:async';
import 'dart:convert';
import 'package:sprintf/sprintf.dart';
import 'package:flutter_sixvalley_ecommerce/utill/util.dart' as utils;
...
Future<CreateOrderResponse> createOrder(int price) async {
  ...
  body["title"] = "Thanh toán mua hàng";
